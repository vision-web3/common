"""Module that defines Vision-web3 entities.
...
from vision.common.types import Amount
from vision.common.types import BlockchainAddress


@dataclasses.dataclass
class ServiceNodeBid:
    """Entity that represents a Vision-web3 service node bid.
...
class TokenDeploymentRequest:
    ...
    Vision-web3 token creator service.
