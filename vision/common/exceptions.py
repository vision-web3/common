"""Common generic exceptions and related classes for vision.
...
class ErrorCreator(abc.ABC, typing.Generic[E]):
    """Base class that helps to properly create Vision-web3 errors for a
...
class BaseError(Exception):
    """Base exception class for all Vision-web3 errors.
...
class NotInitializedError(BaseError):
    """Error to be raised if a Vision-web3 resource has not been properly
