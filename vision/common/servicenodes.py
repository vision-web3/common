"""Module for communicating with Vision-web3 service nodes.
...
class ServiceNodeClient:
    ...
    def submit_transfer(self, request: SubmitTransferRequest,
        ...
        """Submit a new token transfer request to a Vision-web3 service node.
