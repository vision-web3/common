...
from vision.common.protocol import get_supported_protocol_versions
from vision.common.protocol import is_supported_protocol_version
...
def test_get_latest_protocol_version_correct(supported_protocol_versions,
    ...
    with unittest.mock.patch(
            'vision.common.protocol._SUPPORTED_PROTOCOL_VERSIONS',
